...
lighweight mock GraphQL service that simulates the real GraphQL service from SPM.
...
data fetcher functions in GraphQl paralance) that resolve to data values. The `data` directory is a subset of the resolvers directory and contains the

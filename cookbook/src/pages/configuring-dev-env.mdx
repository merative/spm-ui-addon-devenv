...
(Mandatory) Specifies the location of the compiled JavaScript relative to the server. This is only needed if configuring the static content server. For example:

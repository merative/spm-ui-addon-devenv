...
(Development only) Specifies the location of the `webclient` directory in the development installation. This value is used to test the integration of the Carbon custom widgets with custom pages (UIM/VIM) in SPM. For example:

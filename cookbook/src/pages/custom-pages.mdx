---
title: Overview of creating pages
description: Oveview of creating custom pages
---

Custom pages, such as the Caseworker Overview page, consist of Carbon components that are rendered on a UIM page in the Social Program Management application.

To get you started, we describe how you can implement a custom page that contains a Carbon component called `componentX`, and how to set up a GraphQL mock service to test your component with mock data. Refer to the provided code samples for guidance as you develop your new component.
